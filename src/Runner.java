...
public class Runner {
 ...
 Item 62 2-pin:
        String guess1 ="Y_x,Y_y";
        String con1 = "B_x,Y_y";
        Feedback feed1 = new GR(guess1);
        naturalDedTwoPinDMM(feed1,con1);
        String guess2 = "B_x,Y_y";
        String con2 =  "Y_x,B_y";
        Feedback feed2 = new OO(guess2);
        naturalDedTwoPinDMM(feed2,con2);
